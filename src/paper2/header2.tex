\ChapterHeader{
  ...
  Emily Bunster\footnote{\label{CDRG-2}Culinary Dynamics Research Group},
  Guy Fieri\footnote{\label{HDIM-2}Hot Dog Institute of Mathematics},
  and
  Samantha Zest\footnote{\label{CRC}Condiment Research Center}
}{
  \begin{itemize}
